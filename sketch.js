...
function setup() {
  ...
  reiniciar = createSprite(width/2,height-250);
  ...
  soloInvisivel = createSprite(200,height-15,400,10);
...
function draw() {
  //trex.debug = true;
  background(255);
  text("Pontuação: "+ pontuacao, width-130,height-250);
...
function gerarNuvens() {
  ...
  if (frameCount % 60 === 0) {
    nuvem = createSprite(width+100,height-40,40,10);
    nuvem.y = Math.round(random(height-150,height-250));
...
function gerarObstaculos() {
  if(frameCount % 60 === 0) {
    var obstaculo = createSprite(width+100,height-50,10,40);
